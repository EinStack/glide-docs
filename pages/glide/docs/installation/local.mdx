...
It's possible to install Glide binary into various platforms.
...
<DarkOnly>
    [![Get it from the Snap Store](https://snapcraft.io/static/images/badges/en/snap-store-black.svg)](https://snapcraft.io/glide)
</DarkOnly>
